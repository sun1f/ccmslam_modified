...
#define LLLS                               \
    if (mSysState == eSystemState::SERVER) \
        cout << __LINE__ << " --- " << ros::Time::now() << endl;
...
namespace estd
{
    ...
    public:
        // Black
        static RGB255 rgbBlack()
        {
            RGB255 black(0, 0, 0);
            return black.rgb();
        }
        static uint32_t pclBlack()
        {
            RGB255 black(0, 0, 0);
            return black.rgbpcl();
        }
        static std_msgs::ColorRGBA msgBlack()
        {
        ...
        // White
        static RGB255 rgbWhite()
        {
            RGB255 white(255, 255, 255);
            return white.rgb();
        }
        static uint32_t pclWhite()
        {
            RGB255 white(255, 255, 255);
            return white.rgbpcl();
        }
        static std_msgs::ColorRGBA msgWhite()
        {
        ...
        // Red
        static RGB255 rgbRed()
        {
            RGB255 red(255, 0, 0);
            return red.rgb();
        }
        static uint32_t pclRed()
        {
            RGB255 red(255, 0, 0);
            return red.rgbpcl();
        }
        static std_msgs::ColorRGBA msgRed()
        {
        ...
        // Green
        static RGB255 rgbGreen()
        {
            RGB255 green(0, 255, 0);
            return green.rgb();
        }
        static uint32_t pclGreen()
        {
            RGB255 green(0, 255, 0);
            return green.rgbpcl();
        }
        static std_msgs::ColorRGBA msgGreen()
        {
        ...
        // DarkGreen
        static RGB255 rgbDarkGreen()
        {
            RGB255 darkgreen(0, 255, 0);
            return darkgreen.rgb();
        }
        static uint32_t pclDarkGreen()
        {
            RGB255 darkgreen(0, 255, 0);
            return darkgreen.rgbpcl();
        }
        static std_msgs::ColorRGBA msgDarkGreen()
        {
            std_msgs::ColorRGBA darkgreen;
            darkgreen.r = 0.0;
            darkgreen.g = 0.8;
            darkgreen.b = 0.0;
            darkgreen.a = 1.0;
        ...
        // Blue
        static RGB255 rgbBlue()
        {
            RGB255 blue(0, 0, 255);
            return blue.rgb();
        }
        static uint32_t pclBlue()
        {
            RGB255 blue(0, 0, 255);
            return blue.rgbpcl();
        }
        static std_msgs::ColorRGBA msgBlue()
        {
        ...
        // Magenta
        static RGB255 rgbMagenta()
        {
            RGB255 magenta(255, 0, 255);
            return magenta.rgb();
        }
        static uint32_t pclMagenta()
        {
            RGB255 magenta(255, 0, 255);
            return magenta.rgbpcl();
        }
        static std_msgs::ColorRGBA msgMagenta()
        {
        ...
        // DarkMagenta
        static RGB255 rgbDarkMagenta()
        {
            RGB255 markmagenta(255, 0, 255);
            return markmagenta.rgb();
        }
        static uint32_t pclDarkMagenta()
        {
            RGB255 markmagenta(255, 0, 255);
            return markmagenta.rgbpcl();
        }
        static std_msgs::ColorRGBA msgDarkMagenta()
        {
            std_msgs::ColorRGBA markmagenta;
            markmagenta.r = 1.0;
            markmagenta.g = 0.0;
            markmagenta.b = 1.0;
            markmagenta.a = 1.0;
        ...
        // Cyan
        static RGB255 rgbCyan()
        {
            RGB255 cyan(0, 255, 255);
            return cyan.rgb();
        }
        static uint32_t pclCyan()
        {
            RGB255 cyan(0, 255, 255);
            return cyan.rgbpcl();
        }
        static std_msgs::ColorRGBA msgCyan()
        {
        ...
        // Yellow
        static RGB255 rgbYellow()
        {
            RGB255 yellow(255, 255, 0);
            return yellow.rgb();
        }
        static uint32_t pclYellow()
        {
            RGB255 yellow(255, 255, 0);
            return yellow.rgbpcl();
        }
        static std_msgs::ColorRGBA msgYellow()
        {
        ...
        // Orange
        static RGB255 rgbOrange()
        {
            RGB255 orange(255, 128, 0);
            return orange.rgb();
        }
        static uint32_t pclOrange()
        {
            RGB255 orange(255, 128, 0);
            return orange.rgbpcl();
        }
        static std_msgs::ColorRGBA msgOrange()
        {
        ...
        // Gold
        static RGB255 rgbGold()
        {
            RGB255 gold(212, 175, 55);
            return gold.rgb();
        }
        static uint32_t pclGold()
        {
            RGB255 gold(212, 175, 55);
            return gold.rgbpcl();
        }
        static std_msgs::ColorRGBA msgGold()
        {
            std_msgs::ColorRGBA gold;
            gold.r = 0.831;
            gold.g = 0.686;
            gold.b = 0.216;
            gold.a = 1.0;
        ...
        // Dark Gray
        static RGB255 rgbDarkGray()
        {
            RGB255 darkgray(105, 105, 105);
            return darkgray.rgb();
        }
        static uint32_t pclDarkGray()
        {
            RGB255 darkgray(105, 105, 105);
            return darkgray.rgbpcl();
        }
        static std_msgs::ColorRGBA msgDarkGray()
        {
            std_msgs::ColorRGBA darkgray;
            darkgray.r = 0.412;
            darkgray.g = 0.412;
            darkgray.b = 0.412;
            darkgray.a = 1.0;
        ...
        // Light Gray
        static RGB255 rgbLightGray()
        {
            RGB255 lightgray(105, 105, 105);
            return lightgray.rgb();
        }
        static uint32_t pclLightGray()
        {
            RGB255 lightgray(105, 105, 105);
            return lightgray.rgbpcl();
        }
        static std_msgs::ColorRGBA msgLightGray()
        {
            std_msgs::ColorRGBA lightgray;
            lightgray.r = 0.6;
            lightgray.g = 0.6;
            lightgray.b = 0.6;
            lightgray.a = 1.0;
    ...
    public:
        ...
        void SetMapping(int iLine, int iClientId)
        {
            std::unique_lock<std::mutex> lock(mMutexMapping);
            mvMappingState[iClientId] = iLine;
            mvdLastTimeMapping[iClientId] = ros::Time::now().toSec();
        }
        void SetComm(int iLine, int iClientId)
        {
            std::unique_lock<std::mutex> lock(mMutexComm);
            mvCommState[iClientId] = iLine;
            mvdLastTimeComm[iClientId] = ros::Time::now().toSec();
        }
        void SetKF(int iLine, int iClientId)
        {
            std::unique_lock<std::mutex> lock(mMutexKF);
            mvKFState[iClientId] = iLine;
        }
        void SetMP(int iLine, int iClientId)
        {
            std::unique_lock<std::mutex> lock(mMutexMP);
            mvMPState[iClientId] = iLine;
        }
        void SetLoop(int iLine, int iClientId)
        {
            std::unique_lock<std::mutex> lock(mMutexLoop);
            mvLoopState[iClientId] = iLine;
            mvdLastTimeLoop[iClientId] = ros::Time::now().toSec();
        }
        void SetMatch(int iLine, int iClientId)
        {
            std::unique_lock<std::mutex> lock(mMutexMatch);
            mvMatchState[iClientId] = iLine;
            mdLastTimeMatch = ros::Time::now().toSec();
        }
        void SetMerge(int iLine, int iClientId)
        {
            std::unique_lock<std::mutex> lock(mMutexMerge);
            mvMergeState[iClientId] = iLine;
        }
        void SetOpt(int iLine, int iClientId)
        {
            std::unique_lock<std::mutex> lock(mMutexOpt);
            mvOptState[iClientId] = iLine;
        }

        void SetMappingLock(int iLine, int iClientId)
        {
            std::unique_lock<std::mutex> lock(mMutexMappingLock);
            mvMappingLock[iClientId] = iLine;
        }

        void SetFinished(int iClientId)
        {
            std::unique_lock<std::mutex> lock(mMutexFinished);
            mvbFinished[iClientId] = true;
        }
